...
| `reasoning` | `{ effort?: "low" \| "medium" \| "high"; max_tokens?: number; enabled?: boolean }` | no | enabled on capable models | Reasoning controls. `enabled: false` disables reasoning entirely. |
