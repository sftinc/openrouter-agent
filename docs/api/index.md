...
| [OpenRouter Client](./openrouter.md) | `src/openrouter/` | `OpenRouterClient` (`complete`, `completeStream`, `embed`), `setOpenRouterClient`, `OpenRouterError`, `DEFAULT_MODEL`, `LLMConfig`, `OpenRouterClientOptions`, `OpenRouterTool`, `CompletionsRequest`, `CompletionsResponse`, `EmbedRequest`, `EmbedResponse`, `RequestOptions`, `RetryConfig`, `defaultIsRetryable`, `StreamTruncatedError`, `IdleTimeoutError` |
